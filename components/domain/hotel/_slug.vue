...
<!-- <div class="min-h-screen" :style="{
  ...
  <div class="pt-6 pb-[100px] sm:pb-8 sm:pt-[200px] px-6 sm:px-[203.5px] grid grid-cols-1 sm:grid-cols-[2fr_1fr] gap-12 items-center">
    <div>
      <h1 class="title">
        {{hotel.name}}
      </h1>
      <div class="flex items-center gap-4 my-6">
        ...
        <p class="text-[#EBE600] text-2xl font-medium">
          {{hotel.address}}
        </p>
      </div>
      <div>
      ...
      <p class="text-white font-medium mt-6">
        {{hotel.description}}
      </p>
    </div>
    <div class="flex flex-col gap-6">
      <h2 class="text-[#EBE600] text-2xl uppercase font-semibold text-center">
...
<!-- <div>
  <div class="block md:hidden min-h-screen h-full px-[25px] pt-[45px] pb-[105px]"
  :style="{
      background: `url(${require('@/assets/img/countryMobileBG.png')}) no-repeat, #000`,
      backgroundSize: '100% auto',
    }">
    <div class="flex justify-between gap-2.5">
      <NuxtLink :to="`/country/${$route.params.slug}`">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
          <g clip-path="url(#clip0_2559_3027)">
          <path d="M15.5607 8.93885C16.0932 9.47138 16.1416 10.3047 15.7059 10.8919L15.5607 11.0602L2.622 23.9995L15.5607 36.9389C16.0932 37.4714 16.1416 38.3047 15.7059 38.8919L15.5607 39.0602C15.0281 39.5927 14.1948 39.6411 13.6076 39.2054L13.4393 39.0602L-0.560659 25.0602C-1.09319 24.5276 -1.14161 23.6943 -0.705896 23.1071L-0.560659 22.9389L13.4393 8.93885C14.0251 8.35307 14.9749 8.35307 15.5607 8.93885Z" fill="white"/>
          </g>
          <defs>
          <clipPath id="clip0_2559_3027">
          <rect width="48" height="48" fill="white" transform="translate(0 -0.000488281)"/>
          </clipPath>
          </defs>
        </svg>
      </NuxtLink>
      <div class="flex flex-col items-end gap-3 font-bold">
        <p class="text-xl title_color text-right">
          Amilla Maldives Resort & Residences 5* Deluxe
        </p>
        <div class="flex items-center gap-3">
          <p class="text-[#EBE600]">
            Accusamus in dolorem
          </p>
          <svg xmlns="http://www.w3.org/2000/svg" width="26" height="25" viewBox="0 0 26 25" fill="none">
            <path d="M12.7707 13.5493C13.2077 13.5493 13.6405 13.4679 14.0442 13.3097C14.448 13.1515 14.8148 12.9196 15.1239 12.6273C15.4329 12.335 15.678 11.988 15.8453 11.6061C16.0125 11.2241 16.0986 10.8148 16.0986 10.4014C16.0986 9.98799 16.0125 9.57864 15.8453 9.19671C15.678 8.81478 15.4329 8.46775 15.1239 8.17544C14.8148 7.88312 14.448 7.65124 14.0442 7.49304C13.6405 7.33484 13.2077 7.25342 12.7707 7.25342C11.8881 7.25342 11.0417 7.58508 10.4176 8.17544C9.79348 8.76579 9.44287 9.56649 9.44287 10.4014C9.44287 11.2363 9.79348 12.037 10.4176 12.6273C11.0417 13.2177 11.8881 13.5493 12.7707 13.5493Z" stroke="white" stroke-width="2.07558"/>
            <path d="M3.83315 8.56526C5.93438 -0.172358 19.6191 -0.162268 21.7097 8.57535C22.9363 13.7009 19.5658 18.0394 16.6112 20.7233C15.5788 21.6652 14.2004 22.1915 12.7661 22.1915C11.3317 22.1915 9.95332 21.6652 8.92092 20.7233C5.97705 18.0394 2.60654 13.6908 3.83315 8.56526Z" stroke="white" stroke-width="2.07558"/>
          </svg>
        </div>
      </div>
    </div>
    <img src="@/assets/img/slider/mainPage/3.png" alt="" class="py-8 rounded-lg">
    <p class="text-white font-bold text-sm leading-[20px] text-center">
      Оазис вилл с бассейном, Anantara Kihavah Villas - это роскошный курорт на Мальдивах, который предлагает максимальную приватность и спокойствие, ваше собственное убежище в святилище.
Невероятной красоты остров пространство с великолепной тропической природой, с частными бассейнами, высокими потолками и деревянными интерьерами. Насладитесь изысканным кулинарным искусством и винным разнообразием в одном из немногих подводных ресторанов и винных погребов в мире.
    </p>
  ...
  <div class="hidden md:block h-screen" :style="{
      background: `url(${require('@/assets/img/mainPageBG.png')}) no-repeat, #000`,
      backgroundSize: '100% auto',
    }">
    <div class="pt-[200px] px-[94px]">
      hotel
    </div>
  </div>
</div> -->
