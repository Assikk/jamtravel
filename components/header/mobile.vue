<template>
  ...
  <transition name="burger">
    <div v-if="isShowMenu" class="absolute top-0 left-0 w-full text-white h-full pt-[56px] pb-10 px-[35px] flex flex-col gap-[140px]">
      <div class="flex justify-between items-center gap-4 px-[30px]">
    ...
    <div v-if="!isShowMenu" class="px-8 py-[30px] flex gap-4 justify-between items-center">
      <svg width="35" height="35" fill="white" class="cursor-pointer">
